...
write.table(data11, "c:/Documents and Settings/Administrator/Desktop/proj/data11.txt", sep="\t")
write.table(data10, "c:/Documents and Settings/Administrator/Desktop/proj/data10.txt", sep="\t")
write.table(data6, "c:/Documents and Settings/Administrator/Desktop/proj/data6.txt", sep="\t")
write.table(data5, "c:/Documents and Settings/Administrator/Desktop/proj/data5.txt", sep="\t")
write.table(data7, "c:/Documents and Settings/Administrator/Desktop/proj/data7.txt", sep="\t")
write.table(data4, "c:/Documents and Settings/Administrator/Desktop/proj/data4.txt", sep="\t")
write.table(mean_open_rate_per_email_client, "c:/Documents and Settings/Administrator/Desktop/proj/open.email_client.txt", sep="\t")
write.table(mean_click_rate_per_email_client, "c:/Documents and Settings/Administrator/Desktop/proj/click.email_client.txt", sep="\t")
write.table(mean_open_rate_per_region, "c:/Documents and Settings/Administrator/Desktop/proj/open_region.txt", sep="\t")
write.table(mean_click_rate_per_region, "c:/Documents and Settings/Administrator/Desktop/proj/click_region.txt", sep="\t")
